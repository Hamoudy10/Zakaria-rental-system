...
const resetToDefaults = async (req, res) => {
  ...
  const defaultSettings = {
    ...
    'whatsapp_billing_template_name': 'monthly_bill_cron',
    'whatsapp_billing_fallback_template': 'Hello {tenantName}, your {month} bill for {unitCode}: Rent: KSh {rent}, Water: KSh {water}, Arrears: KSh {arrears}. Total: KSh {total}. Pay via paybill {paybill}, Account: {unitCode}. Due by end of month.',
...
const initializeDefaultSettings = async () => {
  ...
  try {
    ...
    const defaultSettings = [
      ...
      { setting_key: 'whatsapp_billing_template_name', setting_value: 'monthly_bill_cron', description: 'Meta WhatsApp template name used for automatic billing messages' },
      { setting_key: 'whatsapp_billing_fallback_template', setting_value: 'Hello {tenantName}, your {month} bill for {unitCode}: Rent: KSh {rent}, Water: KSh {water}, Arrears: KSh {arrears}. Total: KSh {total}. Pay via paybill {paybill}, Account: {unitCode}. Due by end of month.', description: 'Plain text fallback template logged with WhatsApp billing messages' },
