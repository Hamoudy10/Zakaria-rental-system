...
const API_BASE_URL = import.meta.env.VITE_API_URL || "https://zakaria-rental-system.onrender.com";
...
const AIFloatingButton = ({ user }) => {
  ...
  const canSend = canUseAI && !loading && input.trim().length > 0 && Boolean(conversationId);
  ...
  const toggleListening = useCallback(() => {
    ...
    if (!SpeechRecognition) { alert("Speech recognition is not supported in your browser. Please use Chrome or Edge."); return; }
